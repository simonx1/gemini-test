...
def image_summarize(img_base64, prompt):
    ...
    """
    chat =  ChatVertexAI(model_name="gemini-pro-vision", max_output_tokens=2048) # ChatOpenAI(model="gpt-4-vision-preview", max_tokens=1024)
...
vectorstore_mvr = Chroma(
    ...
    embedding_function=VertexAIEmbeddings(model_name="textembedding-gecko@002")
    #embedding_function=GoogleGenerativeAIEmbeddings(model="models/textembedding-gecko"),
)
